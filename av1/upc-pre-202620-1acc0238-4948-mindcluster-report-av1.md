...
<table style="width: auto; border-collapse: collapse; text-align: center;">
  ...
  <tbody>
    <tr>
      <td style="padding: 8px; border: 1px solid #666; text-align: center;">U202422890</td>
      <td style="padding: 8px; border: 1px solid #666; text-align: center;">Cuadros Villanueva, Marcelo Fabio</td>
    </tr>
    <tr>
    ...
    <tr>
      <td style="padding: 8px; border: 1px solid #666; text-align: center;">U202312557</td>
      <td style="padding: 8px; border: 1px solid #666; text-align: center;">Torres Lavandera, Andres Rodrigo</td>
    </tr>
    <tr>
      <td style="padding: 8px; border: 1px solid #666; text-align: center;">U202416706</td>
      <td style="padding: 8px; border: 1px solid #666; text-align: center;">Vargas Alarcon, Santiago Enrique</td>
    </tr>
    <tr>
      <td style="padding: 8px; border: 1px solid #666; text-align: center;">U202318609</td>
      <td style="padding: 8px; border: 1px solid #666; text-align: center;">Wang Chen, Juan Sung Jau</td>
    </tr>
  </tbody>
</table>
</div>
...
Cada participante del equipo sustenta evidencia de cómo las actividades realizadas en el trabajo final han ayudado a desarrollar las dimensiones del student outcome. Por ello, en esta sección se describe por escrito la relación entre el outcome, sus dimensiones y el trabajo que ha realizado cada integrante durante el **Avance 1 (AV1)**. Esto se complementa con lo reflejado en los testimonios expuestos que forman parte del video *About The Team*.
...
En el siguiente cuadro se describen las acciones realizadas y enunciados de conclusiones por parte del grupo, que permiten sustentar el haber alcanzado el logro del ABET – EAC - Student Outcome 7 durante el Avance 1 (AV1).

| Criterio específico | Acciones realizadas | Conclusiones |
|---|---|---|
| Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software. | **Diaz Martinez, Alexther Kamil:**<br>*AV1:* Diseñé las preguntas semiestructuradas de entrevista para los segmentos de pacientes jóvenes y psicólogos profesionales, ejecuté las primeras entrevistas de cada segmento y estructuré el repositorio inicial del proyecto; esto me permitió aplicar técnicas de user research y needfinding en un contexto real de bienestar emocional.<br><br>**Cuadros Villanueva, Marcelo Fabio:**<br>*AV1:* Complementé los segmentos objetivo con fuentes académicas (Senaju, Minsa, CPSP, INSM), conduje y analicé las entrevistas de ambos segmentos objetivo, y desarrollé el diseño táctico completo del Bounded Context Diary (Domain Layer, Interface Layer, Application Layer e Infrastructure Layer); esto me permitió aplicar Domain-Driven Design y fundamentar decisiones de producto con evidencia empírica y académica.<br><br>**Torres Lavandera, Andrés Rodrigo:**<br>*AV1:* Elaboré el Product Backlog priorizado combinando valor de negocio y estimación por Planning Poker, diseñé los Bounded Contexts IAM y Profiles con sus capas de dominio, interfaz, aplicación e infraestructura, construí el Context Mapping estratégico aplicando los patrones DDD (Open Host Service, Anticorruption Layer, Customer/Supplier, Published Language) y elaboré los diagramas de arquitectura en Structurizr DSL y Mermaid; esto me permitió aplicar de forma práctica los conceptos de Domain-Driven Design estratégico y táctico, y de gestión ágil de producto.<br><br>**Vargas Alarcón, Santiago Enrique:**<br>*AV1:* Entrevisté a una psicóloga clínica del segundo segmento objetivo y corregí la información de los integrantes del equipo en la documentación; esto me permitió aplicar técnicas de entrevista a profesionales de salud mental y contrastar sus necesidades clínicas con la propuesta de producto.<br><br>**Wang Chen, Juan Sung Jau:**<br>*AV1:* Redacté la descripción de la startup, el proceso completo de Lean UX (Problem Statements, Assumptions, Hypothesis Statements y Lean UX Canvas), elaboré el User Journey Mapping con la rueda de emociones de Plutchik, modelé el Big Picture EventStorming y el Bounded Context Canvas de AssistantAI, y configuré la importación del Product Backlog a Trello; esto me permitió aplicar Lean UX y EventStorming como metodologías de descubrimiento de producto y diseño estratégico de dominio. | En AV1, el equipo evidenció la actualización de conocimientos al aplicar entrevistas cualitativas, Lean UX, Domain-Driven Design estratégico y táctico (EventStorming, Bounded Context Canvases, Context Mapping), gestión ágil del Product Backlog y modelado C4 con Structurizr, materializando estos conceptos en los entregables concretos del Capítulo II del proyecto SafeDiary. |
| Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software. | **Diaz Martinez, Alexther Kamil:**<br>*AV1:* Investigué técnicas de diseño de preguntas semiestructuradas para minimizar el sesgo del entrevistador al abordar un tema sensible como la salud mental, profundizando en metodologías de entrevista cualitativa que no había aplicado previamente.<br><br>**Cuadros Villanueva, Marcelo Fabio:**<br>*AV1:* Profundicé en el análisis cualitativo de entrevistas para sintetizar patrones entre participantes distintos, y aprendí a modelar un Bounded Context completo bajo DDD táctico, un enfoque de arquitectura que no había aplicado antes en un proyecto de este tamaño.<br><br>**Torres Lavandera, Andrés Rodrigo:**<br>*AV1:* Investigué y apliqué por primera vez el modelado C4 con Structurizr DSL y los patrones de relación entre Bounded Contexts (Shared Kernel, Conformist, Anticorruption Layer, Customer/Supplier), contrastando distintas alternativas de diseño mediante preguntas de exploración ("¿qué pasaría si...?") antes de decidir la arquitectura final; esto fortaleció mi capacidad de evaluar trade-offs arquitectónicos de forma crítica.<br><br>**Vargas Alarcón, Santiago Enrique:**<br>*AV1:* Profundicé en el marco ético y normativo de la telepsicología en el Perú (lineamientos del Colegio de Psicólogos del Perú) para poder formular preguntas de entrevista pertinentes al ejercicio profesional, un tema que no había investigado previamente.<br><br>**Wang Chen, Juan Sung Jau:**<br>*AV1:* Aprendí y apliqué por primera vez la técnica de Big Picture EventStorming y la rueda de emociones de Plutchik para estructurar journey maps emocionalmente precisos, ampliando mi conjunto de herramientas de análisis de experiencia de usuario más allá de lo visto en clase. | En AV1, el equipo demostró aprendizaje permanente al investigar y adoptar por primera vez técnicas y herramientas no cubiertas previamente en el curso —como el modelado C4/Structurizr, la rueda de emociones de Plutchik, el análisis normativo de telepsicología y los patrones de relación entre Bounded Contexts—, transfiriendo este conocimiento entre los integrantes del equipo para elevar la calidad técnica del trabajo colaborativo.|
...
[Presentar al equipo y explicar brevemente cómo sus conocimientos y habilidades contribuyen al proyecto.]
...
| ![Alexther](../assets/images/team-members/Alexther.jpeg) | U202412316 | Diaz Martinez, Alexther Kamil | Ing.Software |Soy Alexther Kamil, estudiante de Ingeniería de Software (6to ciclo). Me encanta trabajar en equipo y me considero alguien positivo y resiliente frente a los problemas. Mi base técnica está en C++, Python, Java, HTML, CSS, JS y SQL, siempre listo para adaptarme a lo que el proyecto nesecite. |
| ![Andres](../assets/images/team-members/andres.jpeg) | U202312557 | Torres Lavandera, Andres Rodrigo | Ing. Software | Soy Andrés Torres, estudiante de Ingeniería de Software en la UPC. Estoy interesado en el desarrollo frontend y backend de aplicaciones, motivado por aprender y fortalecer constantemente mis conocimientos en tecnologías y herramientas de desarrollo. Tengo conocimiento en Python, C++, SQL, Java, HTML, CSS, JavaScript  |
| ![Santiago](../assets/images/team-members/santiago.png) | U202416706 | Vargas Alarcon, Santiago Enrique | Ingenieria de Software | Mi nombre es Santiago Vargas, estudiante de ingenieria de Software de la UPC, y mis conocimientos consisten en Python, C++, algo de C# y un gran manejo en excel. Me cosndiero alguien sociable y con gran capacidad de trabajar en grupos numerosos, capaz de adaptarme a cualquier problema que se me presente. Con este proyecto planeo mejorar mis capacidades en front end y back end. |
...
El Lean UX Canvas es una herramienta de facilitación que consolida en un solo artefacto visual los resultados del proceso de Lean UX. Está compuesto por ocho boxes organizados en una cuadrícula de dos columnas y cuatro filas. El canvas se completa secuencialmente siguiendo la numeración de los boxes (del 1 al 8), y cada box se alimenta del contenido generado en los artefactos anteriores del proceso.

**Tabla 1. Lean UX Canvas de SafeDiary**

| **1. Business Problem** | **5. Solutions** | **2. Business Outcomes** |
|--------------------------|------------------|--------------------------|
| El estado actual del bienestar emocional y la salud mental digital se ha enfocado en dos extremos aislados: aplicaciones de registro emocional sin conexión profesional, y plataformas de terapia online que inician sin contexto previo del paciente.<br><br>Lo que no se ha abordado es la transición gradual y contextualizada entre el registro emocional personal y el acompañamiento profesional.<br><br>Nuestro enfoque inicial son personas que desean un espacio seguro para gestionar sus emociones y profesionales de salud mental que buscan contexto previo de sus nuevos pacientes.<br><br>Sabremos que tenemos éxito cuando los usuarios registren sus emociones de forma recurrente (al menos 3 entradas por semana), un porcentaje significativo contacte a un profesional a través de la plataforma, y los profesionales reporten una reducción en el tiempo necesario para comprender la situación emocional del paciente. | 1) Diario personal digital para registrar entradas emocionales en formato de notas con texto libre.<br><br>2) Chat conversacional con asistente de IA que guíe al usuario a explorar y comprender sus emociones.<br><br>3) Directorio de psicólogos y psiquiatras verificados, accesible cuando el usuario se sienta preparado.<br><br>4) Funcionalidad de contexto compartido que permita al usuario autorizar el acceso del profesional a su historial emocional.<br><br>5) Sistema de gestión de privacidad con control granular sobre qué información se comparte, con quién y en qué momento. | • Incremento en la retención de usuarios activos mensuales.<br>• Mayor frecuencia de interacción diaria con la aplicación.<br>• Incremento en la tasa de conversión de usuarios que contactan a un profesional por primera vez.<br>• Reducción del tiempo que necesita el profesional para comprender la situación emocional de nuevos pacientes.<br>• Incremento en la tasa de registro y adopción inicial de la aplicación. |
| **3. Users** | | **4. User Outcomes and Benefits** |
| **Segmento 1:** Personas que experimentan malestar emocional cotidiano (estrés, ansiedad, tristeza) y buscan un espacio seguro para expresarse, sin necesariamente estar en tratamiento psicológico. Suelen desahogarse con herramientas no especializadas. Enfrentan barreras emocionales, económicas o de tiempo para acceder a un profesional.<br><br>**Segmento 2:** Profesionales de salud mental (psicólogos, psiquiatras) que buscan herramientas digitales para complementar y mejorar la eficacia de su práctica clínica. | | • Los usuarios desean expresar libremente sus pensamientos y emociones en un entorno privado y sin juicios.<br>• Valoran el acompañamiento emocional inmediato y accesible en cualquier momento del día.<br>• Se benefician de la confianza que genera acceder a profesionales verificados dentro de un entorno familiar.<br>• Los profesionales se benefician de contar con contexto emocional previo y estructurado del paciente desde la primera sesión.<br>• Los usuarios necesitan tranquilidad respecto al control total sobre sus datos personales. |
| **6. Hypotheses** | **7. ¿Qué es lo más importante que necesitamos aprender primero?** | **8. ¿Cuál es la menor cantidad de trabajo que necesitamos hacer para aprender lo siguiente?** |
| **H1:** Lograremos mayor retención si los usuarios obtienen expresión libre con el diario personal digital.<br><br>**H2:** Lograremos mayor interacción diaria si los usuarios obtienen acompañamiento inmediato con el chat de IA.<br><br>**H3:** Lograremos mayor conversión a profesionales si los usuarios obtienen confianza con el directorio de expertos verificados.<br><br>**H4:** Reduciremos el tiempo de comprensión del profesional si este obtiene contexto previo con la funcionalidad de contexto compartido.<br><br>**H5:** Lograremos mayor adopción inicial si los usuarios obtienen tranquilidad sobre sus datos con el sistema de gestión de privacidad. | Necesitamos validar si las personas que experimentan malestar emocional estarían dispuestas a registrar sus emociones de forma recurrente en una aplicación móvil, y si confiarían lo suficiente en la plataforma como para compartir su historial emocional con un profesional de salud mental.<br><br>Estas dos validaciones son críticas porque determinan la viabilidad del modelo completo de SafeDiary: sin registro recurrente no hay datos, y sin confianza para compartir no hay diferenciador frente a la competencia. | Desarrollar un MVP que incluya las funcionalidades de diario personal digital y chat con asistente de IA, e implementar un prototipo de la funcionalidad de conexión con expertos con contexto compartido.<br><br>Realizar entrevistas de validación con ambos segmentos objetivo para comprobar si el flujo completo (registrar emociones → generar confianza → contactar profesional con contexto) es percibido como valioso.<br><br>Medir la frecuencia de registro emocional y la disposición a compartir el historial con un profesional. |
...
El desarrollo del primer avance permitió definir **SafeDiary** como una solución orientada al registro y seguimiento del estado emocional de los usuarios, proporcionando un espacio privado para expresar sus experiencias y facilitar el acceso a apoyo profesional.

A nivel funcional, SafeDiary integra características como el **diario personal, check-ins emocionales, asistente de IA, bóveda privada y conexión con profesionales**, considerando el consentimiento y la privacidad del usuario como aspectos fundamentales. Además, se contemplan mecanismos de salvaguarda para situaciones de riesgo, evitando que el asistente de IA sustituya la atención profesional.

En cuanto a la arquitectura, el sistema fue estructurado mediante **Domain-Driven Design**, separando el proyecto en distintos **Bounded Contexts** y aplicando **C4 Model y Clean Architecture**. Esto permite mantener los componentes desacoplados, facilitar el mantenimiento y preparar el sistema para futuras implementaciones y escalabilidad.

Finalmente, este primer avance establece una base sólida para continuar con el desarrollo de **SafeDiary**, dejando definidos sus principales componentes, funcionalidades y criterios arquitectónicos.
...
Colegio de Psicólogos del Perú. (2021). *Guía orientativa para el ejercicio de la telepsicología en el Perú*. Consejo Directivo Nacional. https://www.cpsp.pe

Instituto Nacional de Salud Mental. (2022). *Directiva sanitaria para la implementación de servicios de telesalud y teleinterconsulta en salud mental*. Ministerio de Salud. https://www.insm.gob.pe

Ministerio de Salud. (2024). *Situación de la salud mental y atenciones por problemas afectivos y de ansiedad a nivel nacional*. Plataforma Digital Única del Estado Peruano. https://www.gob.pe/minsa

Organización Mundial de la Salud. (2025, 30 de septiembre). *Trastornos mentales*. https://www.who.int/es/news-room/fact-sheets/detail/mental-disorders

Secretaría Nacional de la Juventud. (2023). *Juventudes Perú: Reporte de datos e indicadores 2017–2023*. Ministerio de Educación. https://juventud.gob.pe
...
| :--- | :--- |
| Informe del proyecto | https://github.com/MindClusterUPC/SafeDiary_Doc |
