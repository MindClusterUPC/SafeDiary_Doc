...
Cada User Story se documenta con la siguiente estructura: identificador, actor (User), prioridad (derivada del orden del Product Backlog, sección 2.4.3) y épica relacionada; seguidos del título, la descripción en formato Como/Quiero/Para y los criterios de aceptación en formato Given/When/Then/And.

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-001</td><td style="text-align:center">Nuevo usuario</td><td style="text-align:center">Alta</td><td style="text-align:center">EP-01</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Registro de cuenta</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> nuevo usuario de SafeDiary,<br><strong>Quiero</strong> registrar una cuenta con mi correo electrónico y una contraseña segura,<br><strong>Para</strong> acceder a mi espacio personal y comenzar a registrar mi estado emocional.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Registro exitoso</strong><br><strong>Given</strong> que el usuario se encuentra en la opción de crear una cuenta<br><strong>When</strong> ingresa un correo no registrado, una contraseña válida y confirma el registro<br><strong>Then</strong> el sistema crea la cuenta e inicia la sesión<br><strong>And</strong> muestra la pantalla principal de bienvenida<br><br><strong>Scenario 2: Datos de registro inválidos</strong><br><strong>Given</strong> que el usuario está completando el formulario de registro<br><strong>When</strong> ingresa un correo con formato incorrecto, un correo ya registrado o una contraseña que no cumple las reglas<br><strong>Then</strong> el sistema no crea la cuenta<br><strong>And</strong> muestra el mensaje de validación correspondiente sin borrar los datos válidos</td></tr>
</table>
...
<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-003</td><td style="text-align:center">Usuario nuevo o recurrente</td><td style="text-align:center">Alta</td><td style="text-align:center">EP-01</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Acceso con Google o Apple</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
...
<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-006</td><td style="text-align:center">Usuario</td><td style="text-align:center">Alta</td><td style="text-align:center">EP-01</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Edición del perfil personal</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> usuario de SafeDiary,<br><strong>Quiero</strong> actualizar mi nombre y fotografía de perfil,<br><strong>Para</strong> mantener mis datos personales al día y personalizar mi experiencia.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Perfil actualizado</strong><br><strong>Given</strong> que el usuario se encuentra en la edición de perfil<br><strong>When</strong> ingresa un nombre válido, selecciona una imagen admitida y guarda los cambios<br><strong>Then</strong> el sistema actualiza la información<br><strong>And</strong> muestra los nuevos datos en la aplicación<br><br><strong>Scenario 2: Imagen no admitida</strong><br><strong>Given</strong> que el usuario intenta cambiar su fotografía<br><strong>When</strong> selecciona un archivo con formato no permitido o que supera el tamaño máximo<br><strong>Then</strong> el sistema conserva la imagen anterior<br><strong>And</strong> muestra el requisito que no se cumplió</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-007</td><td style="text-align:center">Usuario</td><td style="text-align:center">Baja</td><td style="text-align:center">EP-02</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Gestión de rutinas de autocuidado</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> usuario de SafeDiary,<br><strong>Quiero</strong> crear actividades para mis rutinas diarias,<br><strong>Para</strong> organizar hábitos de calma y autocuidado durante el día.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Rutina creada</strong><br><strong>Given</strong> que el usuario se encuentra en la sección de rutinas<br><strong>When</strong> ingresa un nombre, define la duración o el tipo y confirma<br><strong>Then</strong> el sistema agrega la actividad con estado pendiente<br><strong>And</strong> la muestra en la lista del día<br><br><strong>Scenario 2: Rutina sin título</strong><br><strong>Given</strong> que el usuario está creando una actividad<br><strong>When</strong> intenta guardarla sin ingresar un título<br><strong>Then</strong> el sistema no registra la rutina<br><strong>And</strong> señala que el nombre es obligatorio</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-008</td><td style="text-align:center">Usuario</td><td style="text-align:center">Alta</td><td style="text-align:center">EP-02</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Registro de entrada de diario</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> usuario de SafeDiary,<br><strong>Quiero</strong> registrar una vivencia mediante texto o una nota de voz,<br><strong>Para</strong> expresar mis pensamientos con el medio que me resulte más cómodo.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Entrada guardada</strong><br><strong>Given</strong> que el usuario se encuentra en el diario emocional<br><strong>When</strong> escribe una reflexión o graba una nota de voz y selecciona guardar<br><strong>Then</strong> el sistema almacena la entrada cifrada<br><strong>And</strong> la muestra en el historial en orden cronológico<br><br><strong>Scenario 2: Entrada vacía</strong><br><strong>Given</strong> que el usuario abrió una nueva entrada<br><strong>When</strong> intenta guardarla sin texto ni audio<br><strong>Then</strong> el sistema bloquea el guardado<br><strong>And</strong> solicita añadir contenido antes de continuar</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-009</td><td style="text-align:center">Usuario con cita profesional</td><td style="text-align:center">Media</td><td style="text-align:center">EP-01</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Consentimiento para compartir historial</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> usuario de SafeDiary con una cita profesional,<br><strong>Quiero</strong> autorizar explícitamente el acceso de un especialista a partes de mi historial emocional,<br><strong>Para</strong> ofrecer contexto relevante para mi atención sin perder el control de mis datos.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Consentimiento otorgado</strong><br><strong>Given</strong> que el usuario tiene una cita con un especialista verificado<br><strong>When</strong> selecciona los datos que desea compartir, activa el consentimiento y confirma<br><strong>Then</strong> el sistema concede acceso únicamente al especialista y al alcance autorizados<br><strong>And</strong> registra la fecha y el detalle del consentimiento<br><br><strong>Scenario 2: Atención sin compartir historial</strong><br><strong>Given</strong> que el usuario se encuentra en la pantalla de consentimiento<br><strong>When</strong> decide continuar sin autorizar el acceso<br><strong>Then</strong> el sistema mantiene privado el historial<br><strong>And</strong> permite conservar la cita sin compartir información emocional</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-010</td><td style="text-align:center">Usuario</td><td style="text-align:center">Alta</td><td style="text-align:center">EP-02</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Registro rápido del estado emocional</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> usuario de SafeDiary,<br><strong>Quiero</strong> seleccionar rápidamente mi estado emocional actual desde la pantalla principal,<br><strong>Para</strong> mantener un registro continuo de mi ánimo sin crear una entrada completa.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Estado emocional registrado</strong><br><strong>Given</strong> que el usuario se encuentra en la pantalla principal<br><strong>When</strong> selecciona una emoción disponible<br><strong>Then</strong> el sistema registra la emoción con fecha y hora<br><strong>And</strong> actualiza el indicador del estado actual<br><br><strong>Scenario 2: Registro duplicado inmediato</strong><br><strong>Given</strong> que una emoción ya se encuentra activa<br><strong>When</strong> el usuario selecciona nuevamente la misma emoción sin realizar otro cambio<br><strong>Then</strong> el sistema mantiene la selección actual<br><strong>And</strong> evita crear un registro duplicado</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-011</td><td style="text-align:center">Usuario</td><td style="text-align:center">Alta</td><td style="text-align:center">EP-02</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Reflexión guiada por voz con IA</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> usuario de SafeDiary,<br><strong>Quiero</strong> hablar con el asistente de IA y obtener una transcripción, reflexión y etiqueta emocional sugerida,<br><strong>Para</strong> procesar mis pensamientos de manera guiada y guardarlos en mi diario.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Procesamiento de voz exitoso</strong><br><strong>Given</strong> que el usuario inicia una grabación en AI Diary<br><strong>When</strong> habla, detiene la grabación y el procesamiento finaliza correctamente<br><strong>Then</strong> el sistema muestra la transcripción y una reflexión no diagnóstica<br><strong>And</strong> permite revisar la etiqueta sugerida antes de guardar<br><br><strong>Scenario 2: Límite o fallo de transcripción</strong><br><strong>Given</strong> que el usuario está grabando una reflexión<br><strong>When</strong> alcanza el tiempo máximo o la transcripción no puede completarse<br><strong>Then</strong> el sistema detiene la grabación de forma segura<br><strong>And</strong> conserva el audio disponible y ofrece reintentar o usar texto</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-012</td><td style="text-align:center">Usuario</td><td style="text-align:center">Baja</td><td style="text-align:center">EP-02</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Consulta de estadísticas emocionales</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> usuario de SafeDiary,<br><strong>Quiero</strong> visualizar estadísticas de mis estados emocionales a lo largo del tiempo,<br><strong>Para</strong> comprender mis patrones y observar mi progreso personal.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Estadísticas disponibles</strong><br><strong>Given</strong> que el usuario tiene registros emocionales en el periodo seleccionado<br><strong>When</strong> abre Insights y elige un rango de tiempo<br><strong>Then</strong> el sistema calcula y muestra indicadores y gráficos del periodo<br><strong>And</strong> permite consultar el detalle de cada punto del gráfico<br><br><strong>Scenario 2: Periodo sin registros</strong><br><strong>Given</strong> que no existen datos emocionales en el periodo seleccionado<br><strong>When</strong> el usuario abre el panel de estadísticas<br><strong>Then</strong> el sistema muestra un estado vacío sin valores engañosos<br><strong>And</strong> invita a realizar un primer registro</td></tr>
</table>
...
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Contacto telefónico disponible</strong><br><strong>Given</strong> que el usuario se encuentra en la sección Soporte y el dispositivo permite llamadas<br><strong>When</strong> selecciona la opción de ayuda inmediata<br><strong>Then</strong> el sistema abre el marcador con el número de crisis configurado para su ubicación<br><strong>And</strong> solicita al usuario confirmar el inicio de la llamada<br><br><strong>Scenario 2: Dispositivo sin llamadas</strong><br><strong>Given</strong> que el dispositivo no admite llamadas telefónicas<br><strong>When</strong> el usuario selecciona la ayuda inmediata<br><strong>Then</strong> el sistema muestra alternativas disponibles como mensaje, chat o números locales<br><strong>And</strong> no presenta una acción que el dispositivo no puede ejecutar</td></tr>
</table>
...
<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-015</td><td style="text-align:center">Usuario recurrente</td><td style="text-align:center">Alta</td><td style="text-align:center">EP-01</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Desbloqueo biométrico</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> usuario recurrente de SafeDiary,<br><strong>Quiero</strong> habilitar el acceso mediante rostro o huella digital,<br><strong>Para</strong> entrar de forma rápida y segura sin escribir mi contraseña cada vez.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Biometría habilitada</strong><br><strong>Given</strong> que el usuario inició sesión previamente y el dispositivo admite biometría<br><strong>When</strong> activa el desbloqueo biométrico y valida su identidad<br><strong>Then</strong> el sistema habilita el método para futuros accesos<br><strong>And</strong> permite ingresar mediante la validación del dispositivo<br><br><strong>Scenario 2: Validación biométrica fallida</strong><br><strong>Given</strong> que el desbloqueo biométrico está habilitado<br><strong>When</strong> el dispositivo rechaza la identidad después del límite de intentos<br><strong>Then</strong> el sistema no concede acceso<br><strong>And</strong> ofrece iniciar sesión con las credenciales de la cuenta</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-016</td><td style="text-align:center">Usuario</td><td style="text-align:center">Alta</td><td style="text-align:center">EP-01</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Recuperación de contraseña</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> usuario de SafeDiary que olvidó su contraseña,<br><strong>Quiero</strong> solicitar un enlace seguro de restablecimiento,<br><strong>Para</strong> recuperar el acceso sin perder mi historial.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Restablecimiento exitoso</strong><br><strong>Given</strong> que el usuario solicita recuperar su contraseña<br><strong>When</strong> ingresa su correo, abre un enlace vigente y define una contraseña válida<br><strong>Then</strong> el sistema actualiza la credencial<br><strong>And</strong> permite iniciar sesión conservando los datos de la cuenta<br><br><strong>Scenario 2: Correo no reconocido o enlace vencido</strong><br><strong>Given</strong> que el usuario inicia la recuperación<br><strong>When</strong> el correo no está registrado o el enlace dejó de ser válido<br><strong>Then</strong> el sistema no revela la existencia de la cuenta<br><strong>And</strong> muestra un mensaje seguro y permite solicitar un nuevo enlace</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-017</td><td style="text-align:center">Visitante</td><td style="text-align:center">Alta</td><td style="text-align:center">EP-05</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Presentación de la propuesta de valor</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> visitante de la landing page,<br><strong>Quiero</strong> comprender desde la sección principal qué ofrece SafeDiary,<br><strong>Para</strong> decidir si la aplicación responde a mis necesidades.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Propuesta visible</strong><br><strong>Given</strong> que el visitante accede a la landing page<br><strong>When</strong> la sección principal termina de cargar<br><strong>Then</strong> el sistema muestra el mensaje de valor, una descripción breve y las acciones de descarga<br><strong>And</strong> mantiene el contenido principal visible sin desplazamiento en una pantalla compatible<br><br><strong>Scenario 2: Acceso a descarga</strong><br><strong>Given</strong> que el visitante identifica una tienda compatible con su dispositivo<br><strong>When</strong> selecciona el botón de descarga<br><strong>Then</strong> el sistema lo dirige a la tienda correspondiente<br><strong>And</strong> conserva una alternativa informativa si la aplicación aún no está disponible</td></tr>
</table>
...
<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-019</td><td style="text-align:center">Visitante</td><td style="text-align:center">Alta</td><td style="text-align:center">EP-05</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Consulta de testimonios</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> visitante de la landing page,<br><strong>Quiero</strong> leer experiencias de usuarios de SafeDiary,<br><strong>Para</strong> evaluar la confianza y utilidad del producto antes de registrarme.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Testimonios disponibles</strong><br><strong>Given</strong> que el visitante llega a la sección de testimonios<br><strong>When</strong> el contenido se muestra<br><strong>Then</strong> el sistema presenta reseñas con alias o nombre autorizado y calificación<br><strong>And</strong> evita exponer información clínica o emocional identificable<br><br><strong>Scenario 2: Testimonios no disponibles</strong><br><strong>Given</strong> que no existen testimonios aprobados para publicación<br><strong>When</strong> el visitante abre la sección<br><strong>Then</strong> el sistema oculta reseñas incompletas o no autorizadas<br><strong>And</strong> muestra contenido informativo alternativo sin inventar opiniones</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-020</td><td style="text-align:center">Visitante</td><td style="text-align:center">Alta</td><td style="text-align:center">EP-05</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Consulta de planes y precios</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
...
<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-021</td><td style="text-align:center">Visitante</td><td style="text-align:center">Media</td><td style="text-align:center">EP-05</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Preguntas frecuentes y contacto</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> visitante de la landing page,<br><strong>Quiero</strong> consultar respuestas frecuentes y enviar una solicitud de contacto,<br><strong>Para</strong> resolver dudas sobre privacidad, seguridad o funcionamiento.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Consulta de preguntas frecuentes</strong><br><strong>Given</strong> que el visitante se encuentra en la sección de preguntas frecuentes<br><strong>When</strong> selecciona una pregunta<br><strong>Then</strong> la página muestra su respuesta sin recargarse<br><strong>And</strong> permite cerrar la respuesta nuevamente<br><br><strong>Scenario 2: Envío del formulario de contacto</strong><br><strong>Given</strong> que el visitante completa nombre, correo y mensaje válidos<br><strong>When</strong> selecciona enviar<br><strong>Then</strong> el sistema registra la solicitud y confirma su recepción<br><strong>And</strong> si falta un campo obligatorio, muestra la validación y no envía el formulario</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-022</td><td style="text-align:center">Visitante</td><td style="text-align:center">Media</td><td style="text-align:center">EP-05</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Presentación de MindCluster</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> visitante de la landing page,<br><strong>Quiero</strong> conocer la misión y el equipo responsable de SafeDiary,<br><strong>Para</strong> identificar quién respalda el producto y sus valores.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Información institucional visible</strong><br><strong>Given</strong> que el visitante navega a la sección Sobre nosotros<br><strong>When</strong> la sección se muestra<br><strong>Then</strong> el sistema presenta la misión de MindCluster y los valores del equipo<br><strong>And</strong> muestra únicamente datos personales autorizados de sus integrantes<br><br><strong>Scenario 2: Acceso mediante navegación</strong><br><strong>Given</strong> que el visitante se encuentra al inicio de la landing page<br><strong>When</strong> selecciona el enlace Sobre nosotros<br><strong>Then</strong> la página lo dirige a la información institucional<br><strong>And</strong> mantiene una ruta clara para regresar al contenido principal</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-023</td><td style="text-align:center">Usuario</td><td style="text-align:center">Baja</td><td style="text-align:center">EP-01</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Revocación del acceso al historial</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> usuario de SafeDiary,<br><strong>Quiero</strong> revocar el acceso previamente concedido a un especialista,<br><strong>Para</strong> mantener el control sobre quién puede consultar mi información emocional.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Acceso revocado</strong><br><strong>Given</strong> que un especialista tiene autorización vigente sobre parte del historial<br><strong>When</strong> el usuario desactiva el permiso y confirma la revocación<br><strong>Then</strong> el sistema retira el acceso del especialista<br><strong>And</strong> registra la fecha del cambio y muestra una confirmación<br><br><strong>Scenario 2: Consulta de permisos vigentes</strong><br><strong>Given</strong> que el usuario abre la gestión de privacidad<br><strong>When</strong> revisa los accesos concedidos<br><strong>Then</strong> el sistema muestra cada especialista, el alcance y la fecha de autorización<br><strong>And</strong> permite revocar cada permiso por separado</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-024</td><td style="text-align:center">Usuario</td><td style="text-align:center">Baja</td><td style="text-align:center">EP-02</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Recordatorios de registro emocional</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> usuario de SafeDiary,<br><strong>Quiero</strong> configurar recordatorios diarios para registrar mi estado emocional,<br><strong>Para</strong> mantener el hábito de reflexión.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Recordatorio programado</strong><br><strong>Given</strong> que el usuario permitió notificaciones para SafeDiary<br><strong>When</strong> elige una hora y activa el recordatorio diario<br><strong>Then</strong> el sistema programa la notificación<br><strong>And</strong> al seleccionarla abre la pantalla de registro emocional<br><br><strong>Scenario 2: Recordatorio desactivado</strong><br><strong>Given</strong> que existe un recordatorio activo<br><strong>When</strong> el usuario desactiva la opción<br><strong>Then</strong> el sistema cancela las notificaciones futuras asociadas<br><strong>And</strong> conserva disponible la configuración para una reactivación posterior</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-025</td><td style="text-align:center">Usuario</td><td style="text-align:center">Baja</td><td style="text-align:center">EP-01</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Protección de entradas en bóveda privada</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> usuario de SafeDiary,<br><strong>Quiero</strong> proteger entradas específicas con un PIN secundario o biometría,<br><strong>Para</strong> mantener ocultas mis reflexiones más sensibles.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Entrada trasladada a la bóveda</strong><br><strong>Given</strong> que el usuario visualiza una entrada de su diario<br><strong>When</strong> selecciona mover a la bóveda y supera la verificación de seguridad<br><strong>Then</strong> el sistema oculta la entrada del historial general<br><strong>And</strong> la muestra únicamente dentro de la bóveda privada<br><br><strong>Scenario 2: Intentos de acceso fallidos</strong><br><strong>Given</strong> que el usuario intenta abrir la bóveda<br><strong>When</strong> supera el límite de intentos de verificación incorrectos<br><strong>Then</strong> el sistema bloquea temporalmente el acceso<br><strong>And</strong> informa cuándo podrá intentarlo nuevamente</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-026</td><td style="text-align:center">Usuario</td><td style="text-align:center">Baja</td><td style="text-align:center">EP-02</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Personalización del tono de la IA</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> usuario de SafeDiary,<br><strong>Quiero</strong> elegir el estilo de comunicación del asistente de IA,<br><strong>Para</strong> recibir reflexiones que se adapten mejor a mis preferencias.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Tono actualizado</strong><br><strong>Given</strong> que el usuario se encuentra en las preferencias de la IA<br><strong>When</strong> selecciona un estilo disponible y guarda el cambio<br><strong>Then</strong> el sistema aplica el tono a las respuestas futuras<br><strong>And</strong> mantiene el aviso de que la IA brinda apoyo y no diagnóstico<br><br><strong>Scenario 2: Historial sin alteraciones</strong><br><strong>Given</strong> que el usuario cambió el tono del asistente<br><strong>When</strong> consulta conversaciones anteriores<br><strong>Then</strong> el sistema conserva los mensajes con su contenido original<br><strong>And</strong> no regenera respuestas pasadas con el nuevo estilo</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-027</td><td style="text-align:center">Usuario recurrente</td><td style="text-align:center">Baja</td><td style="text-align:center">EP-02</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Seguimiento emocional proactivo</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> usuario recurrente de SafeDiary,<br><strong>Quiero</strong> recibir una pregunta de seguimiento sobre una emoción o situación registrada anteriormente,<br><strong>Para</strong> reflexionar sobre cómo evolucionan mis preocupaciones.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Seguimiento relevante</strong><br><strong>Given</strong> que el usuario autorizó interacciones proactivas y registró una emoción significativa<br><strong>When</strong> abre la aplicación dentro del periodo de seguimiento<br><strong>Then</strong> la IA presenta una pregunta relacionada con el registro previo<br><strong>And</strong> permite responder, omitir o desactivar futuros seguimientos<br><br><strong>Scenario 2: Seguimiento desactivado</strong><br><strong>Given</strong> que el usuario desactiva las interacciones proactivas<br><strong>When</strong> vuelve a abrir la aplicación<br><strong>Then</strong> la IA no inicia conversaciones por cuenta propia<br><strong>And</strong> responde únicamente cuando el usuario comienza una interacción</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-028</td><td style="text-align:center">Usuario</td><td style="text-align:center">Baja</td><td style="text-align:center">EP-02</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Exportación del progreso en PDF</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> usuario de SafeDiary,<br><strong>Quiero</strong> exportar mis estadísticas y entradas seleccionadas en un archivo PDF,<br><strong>Para</strong> compartir mi progreso con un profesional externo si así lo decido.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: PDF generado</strong><br><strong>Given</strong> que el usuario tiene información en el periodo seleccionado<br><strong>When</strong> elige los datos que desea incluir y solicita la exportación<br><strong>Then</strong> el sistema genera un PDF protegido con las estadísticas y entradas autorizadas<br><strong>And</strong> permite descargarlo o compartirlo mediante las opciones del dispositivo<br><br><strong>Scenario 2: Exclusión de datos privados</strong><br><strong>Given</strong> que existen entradas dentro de la bóveda privada<br><strong>When</strong> el sistema prepara la exportación<br><strong>Then</strong> omite esas entradas de forma predeterminada<br><strong>And</strong> no las incluye sin una autorización explícita adicional</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-029</td><td style="text-align:center">Usuario</td><td style="text-align:center">Baja</td><td style="text-align:center">EP-02</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Insignias por constancia emocional</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> usuario de SafeDiary,<br><strong>Quiero</strong> recibir insignias por mantener una racha de registros emocionales,<br><strong>Para</strong> sentirme motivado a sostener el hábito de autocuidado.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Insignia desbloqueada</strong><br><strong>Given</strong> que el usuario está a un registro de completar una meta de constancia<br><strong>When</strong> realiza el registro requerido<br><strong>Then</strong> el sistema concede la insignia correspondiente<br><strong>And</strong> la muestra en el perfil sin revelar información sensible<br><br><strong>Scenario 2: Racha interrumpida</strong><br><strong>Given</strong> que el usuario deja pasar el periodo definido sin registrar actividad<br><strong>When</strong> regresa a la aplicación<br><strong>Then</strong> el sistema reinicia el contador de la racha<br><strong>And</strong> conserva las insignias obtenidas anteriormente</td></tr>
</table>
...
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Sugerencia después de un registro intenso</strong><br><strong>Given</strong> que el usuario registra un nivel alto de ansiedad<br><strong>When</strong> confirma su estado emocional<br><strong>Then</strong> el sistema ofrece iniciar un ejercicio guiado<br><strong>And</strong> permite aceptar, omitir o consultar ayuda profesional<br><br><strong>Scenario 2: Acceso manual</strong><br><strong>Given</strong> que el usuario se encuentra en la navegación principal<br><strong>When</strong> selecciona la opción de ejercicios de regulación<br><strong>Then</strong> el sistema muestra la biblioteca de ejercicios disponibles<br><strong>And</strong> permite iniciar uno sin crear previamente una entrada</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-031</td><td style="text-align:center">Usuario</td><td style="text-align:center">Baja</td><td style="text-align:center">EP-02</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Registro de factores externos</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> usuario de SafeDiary,<br><strong>Quiero</strong> asociar factores como sueño, energía o cafeína a mis registros emocionales,<br><strong>Para</strong> identificar posibles relaciones entre mis hábitos y mi estado de ánimo.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Factores vinculados</strong><br><strong>Given</strong> que el usuario está completando un registro emocional<br><strong>When</strong> selecciona uno o más factores de contexto y guarda<br><strong>Then</strong> el sistema vincula los factores con el registro<br><strong>And</strong> permite consultarlos posteriormente<br><br><strong>Scenario 2: Análisis con información suficiente</strong><br><strong>Given</strong> que existen registros de varios periodos con factores asociados<br><strong>When</strong> el usuario abre Insights<br><strong>Then</strong> el sistema muestra posibles correlaciones como tendencias y no como diagnósticos<br><strong>And</strong> indica cuando la información disponible es insuficiente</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-032</td><td style="text-align:center">Usuario recurrente</td><td style="text-align:center">Baja</td><td style="text-align:center">EP-02</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Recuerdos de evolución emocional</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> usuario recurrente de SafeDiary,<br><strong>Quiero</strong> recibir recordatorios opcionales de cómo me sentía en periodos anteriores,<br><strong>Para</strong> reconocer cambios y obtener perspectiva sobre mi evolución emocional.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Recuerdo mostrado</strong><br><strong>Given</strong> que el usuario autorizó los recuerdos y existe una entrada apta del periodo anterior<br><strong>When</strong> abre la vista general del diario<br><strong>Then</strong> el sistema presenta una tarjeta retrospectiva<br><strong>And</strong> permite ocultarla o desactivar futuros recuerdos<br><br><strong>Scenario 2: Contenido potencialmente sensible</strong><br><strong>Given</strong> que una entrada antigua contiene señales de trauma o fue marcada como sensible<br><strong>When</strong> el sistema selecciona contenido para un recuerdo<br><strong>Then</strong> omite esa entrada de la recomendación automática<br><strong>And</strong> elige contenido neutral o no muestra un recuerdo</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-033</td><td style="text-align:center">Usuario</td><td style="text-align:center">Baja</td><td style="text-align:center">EP-01</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Eliminación de cuenta y datos personales</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> usuario de SafeDiary,<br><strong>Quiero</strong> solicitar la eliminación de mi cuenta y de mis datos emocionales,<br><strong>Para</strong> retirar mi información cuando deje de utilizar el servicio.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Solicitud confirmada</strong><br><strong>Given</strong> que el usuario se encuentra en la gestión de su cuenta<br><strong>When</strong> solicita la eliminación, revisa sus consecuencias y valida nuevamente su identidad<br><strong>Then</strong> el sistema registra la solicitud y cierra las sesiones activas<br><strong>And</strong> informa el plazo de eliminación y revoca los accesos concedidos<br><br><strong>Scenario 2: Cancelación antes de confirmar</strong><br><strong>Given</strong> que el usuario abrió el flujo de eliminación<br><strong>When</strong> decide cancelar antes de la confirmación final<br><strong>Then</strong> el sistema no elimina ni programa la eliminación de datos<br><strong>And</strong> mantiene la cuenta y sus permisos sin cambios</td></tr>
</table>
...
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Ingreso a la consulta</strong><br><strong>Given</strong> que la cita está confirmada y se encuentra dentro de la ventana de acceso<br><strong>When</strong> el usuario selecciona unirse a la videollamada<br><strong>Then</strong> el sistema valida a los participantes y conecta la sesión<br><strong>And</strong> mantiene privado el historial no autorizado<br><br><strong>Scenario 2: Fallo de conexión o acceso fuera de horario</strong><br><strong>Given</strong> que el usuario intenta entrar sin conexión estable o fuera de la ventana permitida<br><strong>When</strong> selecciona el enlace de la consulta<br><strong>Then</strong> el sistema evita un acceso inválido<br><strong>And</strong> muestra opciones para reintentar o contactar al especialista</td></tr>
</table>
...
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Señal de alto riesgo detectada</strong><br><strong>Given</strong> que el usuario envía texto o audio con señales configuradas de peligro inmediato<br><strong>When</strong> el sistema procesa la interacción<br><strong>Then</strong> muestra un mensaje de apoyo con recursos de emergencia según la ubicación configurada<br><strong>And</strong> ofrece contactar a una línea de crisis o profesional sin ejecutar la acción automáticamente<br><br><strong>Scenario 2: Usuario descarta el aviso</strong><br><strong>Given</strong> que el sistema presentó opciones de ayuda urgente<br><strong>When</strong> el usuario decide cerrar el aviso<br><strong>Then</strong> el sistema permite continuar sin afirmar que monitorea su seguridad<br><strong>And</strong> mantiene visible una ruta discreta para volver a los recursos de ayuda</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-041</td><td style="text-align:center">Psicólogo</td><td style="text-align:center">Alta</td><td style="text-align:center">EP-04</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Solicitud de verificación profesional</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
...
<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-042</td><td style="text-align:center">Especialista</td><td style="text-align:center">Media</td><td style="text-align:center">EP-04</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Transparencia del puntaje de confianza</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> especialista verificado,<br><strong>Quiero</strong> consultar las reseñas y los factores que componen mi puntaje de confianza,<br><strong>Para</strong> comprender mi posicionamiento y mejorar la calidad de mi atención.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Desglose disponible</strong><br><strong>Given</strong> que el especialista cuenta con actividad y reseñas válidas<br><strong>When</strong> abre la sección de confianza de su perfil<br><strong>Then</strong> el sistema muestra el puntaje y sus componentes de forma comprensible<br><strong>And</strong> evita revelar la identidad o información emocional de los pacientes<br><br><strong>Scenario 2: Información insuficiente</strong><br><strong>Given</strong> que el especialista todavía no reúne datos suficientes<br><strong>When</strong> consulta su puntaje de confianza<br><strong>Then</strong> el sistema muestra un estado informativo sin asignar una valoración engañosa<br><strong>And</strong> explica qué criterios podrán contribuir cuando exista actividad válida</td></tr>
</table>
...
<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-045</td><td style="text-align:center">Especialista</td><td style="text-align:center">Alta</td><td style="text-align:center">EP-01</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Consulta del resumen emocional autorizado</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> especialista con una relación de atención vigente,<br><strong>Quiero</strong> revisar el resumen emocional que el paciente autorizó compartir,<br><strong>Para</strong> preparar la consulta sin acceder a información excluida de su consentimiento.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Resumen autorizado disponible</strong><br><strong>Given</strong> que el usuario concedió acceso a un periodo y conjunto de datos específicos<br><strong>When</strong> el especialista abre la preparación de la cita<br><strong>Then</strong> el sistema muestra únicamente el resumen y las entradas autorizadas<br><strong>And</strong> registra el acceso con su fecha, actor y alcance<br><br><strong>Scenario 2: Sin autorización vigente</strong><br><strong>Given</strong> que el usuario no compartió información o revocó el permiso<br><strong>When</strong> el especialista intenta consultar el resumen<br><strong>Then</strong> el sistema deniega el acceso<br><strong>And</strong> permite continuar con la cita sin mostrar datos emocionales privados</td></tr>
</table>

<table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse">
<tr><th>Story ID</th><th>User</th><th>Priority</th><th>Epic</th></tr>
<tr><td style="text-align:center">US-046</td><td style="text-align:center">Especialista</td><td style="text-align:center">Media</td><td style="text-align:center">EP-01</td></tr>
<tr><td><strong>Title</strong></td><td colspan="3">Consulta del alcance del consentimiento</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Description</strong></td></tr>
<tr><td colspan="4"><strong>Como</strong> especialista,<br><strong>Quiero</strong> visualizar qué información puedo consultar y hasta cuándo permanece vigente el permiso,<br><strong>Para</strong> respetar el alcance del consentimiento del paciente.</td></tr>
<tr><td colspan="4" style="text-align:center"><strong>Acceptance Criteria</strong></td></tr>
<tr><td colspan="4"><strong>Scenario 1: Permiso vigente visible</strong><br><strong>Given</strong> que el usuario otorgó un consentimiento activo al especialista<br><strong>When</strong> el especialista consulta los permisos de la relación de atención<br><strong>Then</strong> el sistema muestra el periodo, las entradas autorizadas y la vigencia<br><strong>And</strong> diferencia claramente la información que permanece privada<br><br><strong>Scenario 2: Permiso revocado o vencido</strong><br><strong>Given</strong> que el usuario revocó el consentimiento o terminó su vigencia<br><strong>When</strong> el especialista actualiza o vuelve a abrir la vista<br><strong>Then</strong> el sistema retira inmediatamente el acceso<br><strong>And</strong> conserva el evento de revocación o vencimiento en la auditoría</td></tr>
</table>
